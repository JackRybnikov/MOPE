...
t0 = abs(beta0)/sbs                                     #Критерій Стьюдента для кожного коефіціента щоб перевірити чи є
t1 = abs(beta1)/sbs                                     #коефіціент значимий. Якщо ні, то приймається 0 гіпотеза, тобто його
t2 = abs(beta2)/sbs                                     #слід виключити із рівняння регресії
t3 = abs(beta3)/sbs
